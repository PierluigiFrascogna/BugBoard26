...
\begin{itemize}
    \item \texttt{IssueResponse postNewIssue(UUID uuid\_project, IssueRequest issueRequest)} della classe IssueAPI;
    \item \texttt{List<IssueResponse> getIssuesByProject(UUID uuid\_project, String type, String priority, String state)} della classe IssueService.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\linewidth}{|X|X|X|}
        ...
        \hline
        TC\_InvalidProjectUUID           & CE2, CE4                      & Errore: 400     \\
        \hline
        TC\_NotFoundProjectUUID          & CE3, CE4                      & Errore: 404     \\
        \hline
        TC\_InvalidIssueRequest          & CE1, CE5                      & Errore: 400     \\
        \hline
...
\begin{table}[H]
    \centering
    \caption{Oracolo per test del metodo \texttt{List<IssueResponse> getIssuesByProject(UUID uuid\_project, string type, string priority, string state)}}
    \begin{tabularx}{\linewidth}{|X|X|X|}
        \hline
        \textbf{Caso di test} & \textbf{Classe di equivalenza} & \textbf{Esito atteso} \\
        \hline
        TC\_InvalidProjectUUID & CE2, CE\_TNULL, CE\_PNULL, CE\_SNULL & Errore: 400 \\
        \hline
        TC\_NotFoundProjectUUID & CE3, CE\_BUG, CE\_LOW, CE\_PENDING & Errore: 404 \\
        \hline
        TC\_InvalidType & CE1, CE\_TOTHERS, CE\_LOW, CE\_SNULL & Errore: 400 \\
        \hline
        TC\_InvalidPriority & CE1, CE\_BUG, CE\_POTHERS, CE\_SNULL & Errore: 400 \\
        \hline
        TC\_InvalidState & CE1, CE\_BUG, CE\_LOW, CE\_SOTHERS & Errore: 400 \\
        \hline
