...
\includesvg[width=0.50\linewidth]{usersDB} \\[2em]
\includesvg[width=0.50\linewidth]{BugBoardDB}

\subsection{Motivazioni delle scelte adottate?}

\subsection{Strumenti di versioning}
Lo strumento di versioning da noi utilizzato è stato GitHub. È possibile visualizzare la repo al seguente link:
\url{https://github.com/PierluigiFrascogna/BugBoard26}
Qui è, ovviamente, possibile visualizzare ogni possibile statistica relativa a software e contributors, in modo molto più esaustivo di 
