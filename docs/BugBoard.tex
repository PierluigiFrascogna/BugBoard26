...
L'architettura del sistema adottata per la realizzazione della \gls{piattaforma} è di tipo \textbf{Client-Server}, più specificatamente a microservizi. 
...
\begin{enumerate}
        ...
        \item \textbf{API Gateway:} punto di accesso unico per il client web che smista le richieste ai vari microservizi.
...
\begin{itemize}
    ...
    \item \textbf{API Gateway:} \textit{Java con Spring} per il bilanciamento del carico e la gestione delle richieste tra i microservizi.    
    \item \textbf{Backend:} \textit{Java con Spring} per la creazione dei microservizi, grazie alla sua robustezza.
