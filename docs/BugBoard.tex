...
\definecolor{success}{HTML}{93F880}
\definecolor{danger}{HTML}{FF8b8b}
...
\begin{itemize}
    \item \texttt{ResponseEntity<IssueResponse> postNewIssue(UUID uuid\_project, IssueRequest issueRequest)} della classe IssueAPI;
    \item \texttt{ResponseEntity<List<IssueResponse>> getIssuesByProject(UUID uuid\_project, String type, String priority, String state)} della classe IssueService.
\end{itemize}
...
di test ed esaustività degli stessi. Ora illustreremo le informazioni relative al testing di ognuno dei metodi.

\subsubsection{\texttt{ResponseEntity<IssueResponse> postNewIssue(UUID uuid\_project, IssueRequest issueRequest)}}
Questo metodo, come si può intuire dal nome, si occupa di creare nuove issue e racchiuderle nel corretto formato JSON da spedire al 
...
\begin{table}[H]
    \centering
    \caption{Oracolo per test del metodo ResponseEntity<IssueResponse> postNewIssue(UUID uuid\_project, IssueRequest issueRequest)}
    \begin{tabularx}{\linewidth}{|X|X|X|}
        \hline
        \textbf{Caso di test} & \textbf{Classe di equivalenza} & \textbf{Esito atteso}                  \\
        \hline
        \rowcolor{danger}
        TC\_InvalidProjectUUID           & CE2, CE4                      & Codice 400: Bad Request     \\
        \hline
        \rowcolor{danger}
        TC\_NotFoundProjectUUID          & CE3, CE4                      & Codice 404: Not Found     \\
        \hline
        \rowcolor{danger}
        TC\_InvalidIssueRequest          & CE1, CE5                      & Codice 400: Bad Request     \\
        \hline
        \rowcolor{success}
        TC1                             & CE1, CE4                       & Codice 201: Created \& IssueResponse corretta, con tutti i dati della issue creata   \\
        \hline
    \end{tabularx}
\end{table}

\subsubsection{\texttt{ResponseEntity<List<IssueResponse>> getIssuesByProject(UUID uuid\_project, string type, string priority, string state)}}
...
\begin{table}[H]
    \centering
    \caption{Oracolo per test del metodo \texttt{ResponseEntity<List<IssueResponse>> getIssuesByProject(UUID uuid\_project, string type, string priority, string state)}}
    \begin{tabularx}{\linewidth}{|X|X|X|}
        \hline
        \textbf{Caso di test} & \textbf{Classe di equivalenza} & \textbf{Esito atteso} \\
        \hline
        \rowcolor{danger}
        TC\_InvalidProjectUUID & CE2, CE\_TNULL, CE\_PNULL, CE\_SNULL & Codice 400: Bad Request \\
        \hline
        \rowcolor{danger}
        TC\_NotFoundProjectUUID & CE3, CE\_BUG, CE\_LOW, CE\_PENDING & Codice 404: Not Found \\
        \hline
        \rowcolor{danger}
        TC\_InvalidType & CE1, CE\_TOTHERS, CE\_LOW, CE\_SNULL & Codice 400: Bad Request \\
        \hline
        \rowcolor{danger}
        TC\_InvalidPriority & CE1, CE\_BUG, CE\_POTHERS, CE\_SNULL & Codice 400: Bad Request \\
        \hline
        \rowcolor{danger}
        TC\_InvalidState & CE1, CE\_BUG, CE\_LOW, CE\_SOTHERS & Codice 400: Bad Request \\
        \hline
        \rowcolor{success}
        TC1 & CE1, CE\_BUG, CE\_LOW, CE\_TODO & Codice 200: Ok \& Lista di IssueResponse corretta, con tutte le issue che rispettano i filtri \\
        \hline
        \rowcolor{success}
        TC2 & CE1, CE\_QUESTION, CE\_MEDIUM, CE\_PENDING & Codice 200: Ok \& Lista di IssueResponse corretta, con tutte le issue che rispettano i filtri \\
        \hline
        \rowcolor{success}
        TC3 & CE1, CE\_FEATURE, CE\_HIGH, CE\_DONE & Codice 200: Ok \& Lista di IssueResponse corretta, con tutte le issue che rispettano i filtri \\
        \hline
        \rowcolor{success}
        TC4 & CE1, CE\_DOCUMENTATION, CE\_PNULL, CE\_SNULL & Codice 200: Ok \& Lista di IssueResponse corretta, con tutte le issue che rispettano i filtri \\
        \hline
        \rowcolor{success}
        TC5 & CE1, CE\_TNULL, CE\_PNULL, CE\_SNULL & Codice 200: Ok \& Lista di IssueResponse corretta, con tutte le issue che rispettano i filtri \\
        \hline
    \end{tabularx}
\end{table}
